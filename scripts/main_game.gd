...
var idleAnimation = preload("res://resources/heat_button_start_heat_idle_output.ogv")
...
func _on_button_pressed() -> void:
    ...
    video_player.set_stream(idleAnimation)
    video_player.play()

	#Work on creating a blinking effect for some random time
